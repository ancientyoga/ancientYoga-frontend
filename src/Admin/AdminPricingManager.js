    ...
    <section className="pricing-section bg-light py-5">
      <div className="container text-center">
        ...
        <div className="row justify-content-center g-4">
          {plans.map(plan => (
            <div className="col-md-5 col-sm-10" key={plan.id}>
              <div className={`pricing-card border ${plan.badge === 'Best Value' ? 'border-success shadow' : 'shadow-sm'} rounded-4 p-4 h-100 bg-white position-relative`}>
                ...
                <Link to={plan.route} className={`btn ${plan.badge === 'Best Value' ? 'btn-success' : 'btn-outline-primary'} rounded-pill px-4 py-2`}>
